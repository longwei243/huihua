...
public class BoHaoActivity extends Activity{
		...
		public void onClick(View v) {
			...
			case R.id.bohao_btn_continue:
				if(!"".equals(bohao_edit_num.getText().toString().trim())) {
					...
					Toast.makeText(BoHaoActivity.this, "请输入号码", Toast.LENGTH_SHORT).show();
				}
				break;
	...
	private void add_complete(SelectContactBean scb) {
		...
		Intent intent = new Intent(BoHaoActivity.this, NMDetailActivity.class);
		intent.putExtra("bohaolist", (Serializable)list);
